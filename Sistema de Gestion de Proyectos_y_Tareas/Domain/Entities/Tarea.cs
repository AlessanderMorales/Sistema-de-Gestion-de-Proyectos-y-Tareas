...
namespace Sistema_de_Gestion_de_Proyectos_y_Tareas.Domain.Entities
{
    public class Tarea : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("No se permiten intentos explícitos de inyección SQL o contenido HTML/JS peligroso.", new[] { nameof(Titulo), nameof(Descripcion), nameof(Prioridad) });
            }
        }
