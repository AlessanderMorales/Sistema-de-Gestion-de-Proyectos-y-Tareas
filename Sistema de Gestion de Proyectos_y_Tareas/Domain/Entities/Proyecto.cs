...
namespace Sistema_de_Gestion_de_Proyectos_y_Tareas.Domain.Entities
{
    public class Proyecto : IValidatableObject
    {
        ...
        public IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
        {
            ...
            {
                yield return new ValidationResult("Los campos de texto contienen intentos explícitos de inyección SQL o contenido HTML/JS peligroso.", new[] { nameof(Nombre), nameof(Descripcion) });
            }
        }
